# Google-Art （google是一种艺术）

> [汇总-190425更新](https://ysai.work/2019/03/02/科学上网/)
> **[参考](https://github.com/wcmbeta/GFWdata)**

免费版
----
## 1、Blue灯(500M/月免费)  [官网](https://getlantern.org/zh_CN/index.html)  [Github](https://github.com/getlantern/lantern/releases/tag/latest)
...
## 2、Windcribe(10G/月免费)  [官网](https://windscribe.com/)
...
自建
----
## 1、[ss](https://github.com/shadowsocksrr/shadowsocksr-csharp/releases)
### 服务端
...
## 2、[vray](https://github.com/v2ray/v2ray-core/releases)
...
## 3、[Brooks](https://github.com/txthinking/brook/releases)
...
## 4、[Wire](https://www.atrandys.com/2018/1345.html)
